...
- Signing: Do not commit keystore files or passwords. Set the following in `~/.gradle/gradle.properties` or a local, untracked file such as `android/keystore.properties`:
