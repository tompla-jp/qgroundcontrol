...
1. Install Additional Packages (Platform Specific)
  ...
  - **Android** [Setup](https://doc.qt.io/qt-6/android-getting-started.html). JDK17 is required for the latest updated versions. NDK Version: 26.1.10909125 (older NDKs ship libc++_shared without the required std::pmr symbols and crash at startup)
